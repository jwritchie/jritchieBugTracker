    ...
    public class ManageController : UniversalController
    {
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ...
            var model = new IndexViewModel
            {
                ...
                SelectedRoles = helper.ListUserRoles(userId).ToArray()
        };
            return View(model);
        }
        ...
        public ActionResult ChangeProfile()
        {
            ...
            if (userName != "admin@coderfoundry.com" && userName != "projectmanager@coderfoundry.com" &&
               userName != "developer@coderfoundry.com" && userName != "submitter@coderfoundry.com")
            {
                return View(user);
            }
